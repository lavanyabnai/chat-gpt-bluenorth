        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} disabled={disabled} placeholder="Location name" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} disabled={disabled} placeholder="Location code" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea {...field} disabled={disabled} placeholder="Full address" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
            ...
            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
              ...
              <div className="space-y-1 leading-none">
                ...
                <p className="text-sm text-muted-foreground">
                  Automatically fill latitude and longitude based on the address.
                </p>
              </div>
            </FormItem>
          )}

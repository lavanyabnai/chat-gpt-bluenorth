...
import { MdAltRoute, MdFactory } from 'react-icons/md'
import { FaWarehouse, FaShoppingCart } from 'react-icons/fa'
import { GiCargoShip } from 'react-icons/gi'

import { ReactFlow, useNodesState, useEdgesState, addEdge, Edge, Connection } from '@xyflow/react'
      ...
      <div className="m-4">
        ...
        <div className="border  rounded-lg">
          <ReactFlow
            ...
            fitView
            className="
            bg-zinc-50 w-full h-[800px] flex justify-start items-center overflow-y-auto"
          >
            {/* <MiniMap />
      <Controls /> */}
          </ReactFlow>
